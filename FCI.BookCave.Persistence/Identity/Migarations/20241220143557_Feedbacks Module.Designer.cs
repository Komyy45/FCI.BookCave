...
namespace FCI.BookCave.Persistence.Identity.Migarations
{
    ...
    [Migration("20241220143557_Feedbacks Module")]
    partial class FeedbacksModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Feedbacks.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Feedbacks.FeedbackCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Feedbacks.Feedback", b =>
                {
                    b.HasOne("FCI.BookCave.Domain.Entities.Feedbacks.FeedbackCategory", "Category")
                        .WithMany()
                        .HasForeignKey("FeedbackCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FCI.BookCave.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithMany()
