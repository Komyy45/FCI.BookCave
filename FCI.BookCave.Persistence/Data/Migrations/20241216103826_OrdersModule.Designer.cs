...
namespace FCI.BookCave.Persistence.Data.Migrations
{
    ...
    [Migration("20241216103826_OrdersModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Orders.Order", b =>
                {
                    b.OwnsOne("FCI.BookCave.Domain.Entities.Common.Address", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("FCI.BookCave.Domain.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("FCI.BookCave.Domain.Entities.Orders.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
